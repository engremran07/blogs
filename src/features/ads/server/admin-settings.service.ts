...
export class AdsAdminSettingsService {
  ...
  async getConfig(): Promise<AdsConfig> {
    ...
    const config: AdsConfig = {
      ...
      widgetAdConfig: (row.widgetAdConfig as unknown as AdsConfig["widgetAdConfig"]) ?? DEFAULT_ADS_CONFIG.widgetAdConfig,
      ...
      concurrencyPolicy: (row.concurrencyPolicy as unknown as AdsConfig["concurrencyPolicy"]) ?? DEFAULT_ADS_CONFIG.concurrencyPolicy,
